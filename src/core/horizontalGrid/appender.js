...
Gridifier.HorizontalGrid.Appender = function(a, b, c, d, e, f, g, h, i) {
    var j = this;
...
Gridifier.HorizontalGrid.Appender.prototype.append = function(a) {
...
Gridifier.HorizontalGrid.Appender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
    var a = a || false;
...
Gridifier.HorizontalGrid.Appender.prototype._addItemConnectors = function(a, b) {
...
Gridifier.HorizontalGrid.Appender.prototype._createConnectionPerItem = function(a) {
...
Gridifier.HorizontalGrid.Appender.prototype._filterConnectorsPerNextConnection = function() {
    ...
    if (this._settings.isDefaultIntersectionStrategy()) {
        ...
        var b = Gridifier.Connectors.SIDES.RIGHT.TOP;
        this._connectorsSelector.attachConnectors(a);
...
Gridifier.HorizontalGrid.Appender.prototype._findItemConnectionCoords = function(a, b) {
    var c = null;
