...
Gridifier.HorizontalGrid.ItemCoordsExtractor = function(a, b) {
    var c = this;
...
Gridifier.HorizontalGrid.ItemCoordsExtractor.prototype.connectorToAppendedItemCoords = function(a, b) {
...
Gridifier.HorizontalGrid.ItemCoordsExtractor.prototype.connectorToReversedAppendedItemCoords = function(a, b) {
    var c = this._getItemSizesPerAppend(a);
    return {
        x1: parseFloat(b.x),
        x2: parseFloat(b.x + c.targetWidth - 1),
...
Gridifier.HorizontalGrid.ItemCoordsExtractor.prototype.connectorToPrependedItemCoords = function(a, b) {
    var c = this._getItemSizesPerAppend(a);
    return {
...
Gridifier.HorizontalGrid.ItemCoordsExtractor.prototype.connectorToReversedPrependedItemCoords = function(a, b) {
    var c = this._getItemSizesPerAppend(a);
    return {
        x1: parseFloat(b.x - c.targetWidth + 1),
        x2: parseFloat(b.x),
