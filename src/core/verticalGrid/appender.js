...
Gridifier.VerticalGrid.Appender = function(a, b, c, d, e, f, g, h, i) {
    var j = this;
...
Gridifier.VerticalGrid.Appender.prototype.append = function(a) {
...
Gridifier.VerticalGrid.Appender.prototype.createInitialConnector = function() {
    this._connectors.addAppendConnector(Gridifier.Connectors.SIDES.LEFT.TOP, parseFloat(this._gridifier.getGridX2()), 0);
};

Gridifier.VerticalGrid.Appender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
    var a = a || false;
...
Gridifier.VerticalGrid.Appender.prototype._addItemConnectors = function(a, b) {
    if (a.x1 - 1 >= 0) {
        this._connectors.addAppendConnector(Gridifier.Connectors.SIDES.LEFT.TOP, parseFloat(a.x1 - 1), parseFloat(a.y1), Dom.toInt(b));
    }
    this._connectors.addAppendConnector(Gridifier.Connectors.SIDES.BOTTOM.RIGHT, parseFloat(a.x2), parseFloat(a.y2 + 1), Dom.toInt(b));
};

Gridifier.VerticalGrid.Appender.prototype._createConnectionPerItem = function(a) {
...
Gridifier.VerticalGrid.Appender.prototype._filterConnectorsPerNextConnection = function() {
    ...
    if (this._settings.isDefaultIntersectionStrategy()) {
        ...
        var b = Gridifier.Connectors.SIDES.BOTTOM.RIGHT;
        this._connectorsSelector.attachConnectors(a);
...
Gridifier.VerticalGrid.Appender.prototype._findItemConnectionCoords = function(a, b) {
    var c = null;
