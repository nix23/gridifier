...
Gridifier.VerticalGrid.ConnectionsSorter = function(a, b, c) {
    var d = this;
...
Gridifier.VerticalGrid.ConnectionsSorter.prototype.sortConnectionsPerReappend = function(a) {
    var b = this;
    if (this._settings.isDisabledSortDispersion()) {
        ...
        if (this._settings.isDefaultAppend()) {
            a.sort(function(a, b) {
                if (Dom.areRoundedOrFlooredValuesEqual(a.y1, b.y1)) {
