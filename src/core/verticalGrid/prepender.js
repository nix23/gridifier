...
Gridifier.VerticalGrid.Prepender = function(a, b, c, d, e, f, g, h, i) {
    var j = this;
...
Gridifier.VerticalGrid.Prepender.prototype.prepend = function(a) {
...
Gridifier.VerticalGrid.Prepender.prototype.createInitialConnector = function() {
    this._connectors.addPrependConnector(Gridifier.Connectors.SIDES.RIGHT.BOTTOM, 0, 0);
};

Gridifier.VerticalGrid.Prepender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
    var a = a || false;
...
Gridifier.VerticalGrid.Prepender.prototype._addItemConnectors = function(a, b) {
    if (a.x2 + 1 <= this._gridifier.getGridX2()) {
        this._connectors.addPrependConnector(Gridifier.Connectors.SIDES.RIGHT.BOTTOM, parseFloat(a.x2 + 1), parseFloat(a.y2), Dom.toInt(b));
    }
    this._connectors.addPrependConnector(Gridifier.Connectors.SIDES.TOP.LEFT, parseFloat(a.x1), parseFloat(a.y1 - 1), Dom.toInt(b));
};

Gridifier.VerticalGrid.Prepender.prototype._createConnectionPerItem = function(a) {
...
Gridifier.VerticalGrid.Prepender.prototype._filterConnectorsPerNextConnection = function() {
    ...
    if (this._settings.isDefaultIntersectionStrategy()) {
        ...
        var b = Gridifier.Connectors.SIDES.TOP.LEFT;
        this._connectorsSelector.attachConnectors(a);
...
Gridifier.VerticalGrid.Prepender.prototype._findItemConnectionCoords = function(a, b) {
    var c = null;
